...
public class DocsController {
	...
	public String loadHolidayPage(@ModelAttribute("holidayVO") HolidayVO holidayVO, ModelMap model,
	...
	public String doHolidayReg(ModelMap model, HttpServletRequest request,
			@Valid @ModelAttribute("holidayVO") HolidayVO holidayVO, BindingResult br) throws Exception {
	...
	public String doPage(ModelMap model, HttpServletRequest request, @PathVariable("docsStatus") String docsStatus,
	...
	public String doRemoveHoliday(@PathVariable("docsName") String docsName, @PathVariable("no") int no)
			throws Exception {
	...
	public String loadDetailHoliday(ModelMap model, HttpServletRequest request,
			@PathVariable("docsType") String docsType, @PathVariable("no") int no,
	...
	public String doPageTrip(ModelMap model, HttpServletRequest request, @PathVariable("docsStatus") String docsStatus,
			@PathVariable("pageNum") int pageNum) {
	...
	public String doTripReg(ModelMap model, HttpServletRequest request, @ModelAttribute TripInputVO tripInputVO)
			throws Exception {
